...
public fun ArchiveMapping.mapMethodDesc(desc: String, fromNamespace: String, toNamespace: String): String {
    ...
    check(signature.name.isBlank()) { "#mapDesc in 'dev.extframework.components.yak.mapping' is only used to map a method descriptor, not its name and descriptor! use #mapMethodSignature instead!" }
